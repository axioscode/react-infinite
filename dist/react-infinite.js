...
(function (global){
"use strict";function _objectWithoutProperties(e,t){var n={};for(var o in e)t.indexOf(o)>=0||Object.prototype.hasOwnProperty.call(e,o)&&(n[o]=e[o]);return n}function createInfiniteComputer(e,t){var n,o=React.Children.count(t);return n=Array.isArray(e)?new ArrayInfiniteComputer(e,o):new ConstantInfiniteComputer(e,o)}function recomputeApertureStateFromOptionsAndScrollTop(e,t){var n=e.preloadBatchSize,o=e.preloadAdditionalHeight,r=e.infiniteComputer,i=0===n?0:Math.floor(t/n),a=n*i,p=a+n,u=Math.max(0,a-o),l=Math.min(r.getTotalScrollableHeight(),p+o);return{displayIndexStart:r.getDisplayIndexStart(u),displayIndexEnd:r.getDisplayIndexEnd(l)}}function generateComputedProps(e){var t=e.containerHeight,n=e.preloadBatchSize,o=e.preloadAdditionalHeight,r=e.handleScroll,i=e.onInfiniteLoad,a=_objectWithoutProperties(e,["containerHeight","preloadBatchSize","preloadAdditionalHeight","handleScroll","onInfiniteLoad"]),p={};t="number"==typeof t?t:0,p.containerHeight=e.useWindowAsScrollContainer?window.innerHeight:t,p.handleScroll=r||function(){},p.onInfiniteLoad=i||function(){};var u={type:scaleEnum.CONTAINER_HEIGHT_SCALE_FACTOR,amount:.5},l=n&&n.type?n:u;"number"==typeof n?p.preloadBatchSize=n:"object"===("undefined"==typeof l?"undefined":_typeof(l))&&l.type===scaleEnum.CONTAINER_HEIGHT_SCALE_FACTOR?p.preloadBatchSize=p.containerHeight*l.amount:p.preloadBatchSize=0;var d={type:scaleEnum.CONTAINER_HEIGHT_SCALE_FACTOR,amount:1},c=o&&o.type?o:d;return"number"==typeof o?p.preloadAdditionalHeight=o:"object"===("undefined"==typeof c?"undefined":_typeof(c))&&c.type===scaleEnum.CONTAINER_HEIGHT_SCALE_FACTOR?p.preloadAdditionalHeight=p.containerHeight*c.amount:p.preloadAdditionalHeight=0,Object.assign(a,p)}function buildHeightStyle(e){return{width:"100%",height:Math.ceil(e)}}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},ConstantInfiniteComputer=require("../computers/constantInfiniteComputer.js"),ArrayInfiniteComputer=require("../computers/arrayInfiniteComputer.js"),scaleEnum=require("./scaleEnum"),React=global.React||require("react"),window=require("./window");module.exports={createInfiniteComputer:createInfiniteComputer,recomputeApertureStateFromOptionsAndScrollTop:recomputeApertureStateFromOptionsAndScrollTop,generateComputedProps:generateComputedProps,buildHeightStyle:buildHeightStyle};
